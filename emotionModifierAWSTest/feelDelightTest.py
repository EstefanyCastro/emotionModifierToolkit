import unittest
from .AWSLambdaConnection import feel_delight


class TestFeelDelight(unittest.TestCase):
    ########## Paul Ekman's emotional model test ##########

    # Test to verify successful update of happiness and surprise with a positive amount
    def test_successful_feel_delight_positive_amount(self):
        # Input values
        ...
        result = feel_delight(emotional_entity, happiness_amount, surprise_amount)
    ...
    def test_successful_feel_delight_negative_amount(self):
    ...
    def test_successful_feel_delight_positive_amount_PAD(self):
    ...
    def test_successful_feel_delight_negative_amount_PAD(self):
        emotional_entity = [10, 10, 10, 5, 5, 12, 50, 60, 10]
        happiness_amount = -5
        surprise_amount = -10
        pleasure_amount = 5
