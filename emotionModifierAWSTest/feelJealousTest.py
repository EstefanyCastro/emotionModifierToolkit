import unittest
from .AWSLambdaConnection import feel_jealous


class TestFeelJealous(unittest.TestCase):
    ########## Paul Ekman's emotional model test ##########

    # Test to verify successful update of sadness and anger with a positive amount
    def test_successful_feel_jealous_positive_amount(self):
        # Input values
        ...
        result = feel_jealous(emotional_entity, sadness_amount, anger_amount)
        ...
        # Expected response
        self.assertEqual(result, [0, 40, 0, 10, 0, 0])

    # Test to verify successful update of sadness and anger with a negative amount
    def test_successful_feel_jealous_negative_amount(self):
        emotional_entity = [0, 50, 0, 30, 0, 0]
        sadness_amount = -10
        anger_amount = -5
        ...
        self.assertIsInstance(result, list)
        self.assertEqual(len(result), 6)
        self.assertEqual(result, [0, 40, 0, 25, 0, 0])

    # Test to verify update when emotional entity, sadness and anger amount are null
    def test_null(self):
    ...
    # Test to verify error when sadness and anger amount is not an integer
    ...
    # Test to verify normalization of excessively negative sadness and anger amount
    def test_normalize_excessive_negative_sadness_amount(self):
        ...
        self.assertIsInstance(result, list)
        self.assertEqual(len(result), 6)
        self.assertEqual(result, [10, 0, 30, 0, 0, 6])
    ...
    def test_normalize_excessive_array(self):
        ...
        self.assertIsInstance(result, list)
        self.assertEqual(len(result), 6)
        self.assertEqual(result, [64, 6, 9, 16, 1, 1])

    # Test to verify normalization of excessive sadness and anger amount
    def test_normalize_excessive_sadness_amount(self):
        ...
        self.assertIsInstance(result, list)
        self.assertEqual(len(result), 6)
        self.assertEqual(result, [2, 42, 8, 44, 1, 1])

    # ########## PAD's emotional model test ##########

    # Test to verify successful update of sadness and anger with positive amount for PAD model
    def test_successful_feel_jealous_positive_amount_PAD(self):
        ...
        self.assertEqual(result, [10, 40, 10, 15, 5, 12, 55, 90, 92])

    # Test to verify successful update of sadness and anger with negative amount for PAD model
    def test_successful_feel_jealous_negative_amount_PAD(self):
        ...
        self.assertIsInstance(result, list)
        self.assertEqual(len(result), 9)
        self.assertEqual(result, [10, 5, 10, 15, 5, 12, 55, 90, 92])
    ...
    # Test to verify error due to non-integer sadness and anger amount in PAD model
    ...
    # Test to verify normalization of excessively negative sadness and anger amount in PAD model
    def test_normalize_excessive_negative_sadness_amount_PAD(self):
        ...
        self.assertIsInstance(result, list)
        self.assertEqual(len(result), 9)
        self.assertEqual(result, [10, 0, 10, 0, 5, 12, 25, 90, 92])
    ...
    def test_normalize_excessive_array_PAD(self):
        ...
        self.assertIsInstance(result, list)
        self.assertEqual(len(result), 9)
        self.assertEqual(result, [3, 38, 3, 20, 30, 4, 55, 90, 92])

    # Test to verify normalization of excessive sadness and anger amount for PAD model
    def test_normalize_excessive_sadness_amount_PAD(self):
        ...
        self.assertIsInstance(result, list)
        self.assertEqual(len(result), 9)
        self.assertEqual(result, [1, 56, 1, 37, 0, 2, 55, 90, 92])
    ...
    def test_normalize_negative_dominance_amount_PAD(self):
        ...
        self.assertIsInstance(result, list)
        self.assertEqual(len(result), 9)
        self.assertEqual(result, [10, 12, 10, 15, 5, 12, 25, 90, 0])
    ...
    def test_normalize_excessive_pleasure_amount_PAD(self):
        ...
        self.assertIsInstance(result, list)
        self.assertEqual(len(result), 9)
        self.assertEqual(result, [10, 40, 10, 15, 5, 12, 100, 90, 92])
