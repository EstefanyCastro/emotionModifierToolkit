import unittest
from .AWSLambdaConnection import feel_envy


class TestFeelEnvy(unittest.TestCase):
    ########## Paul Ekman's emotional model test ##########

    # Test to verify successful update of sadness and anger with a positive amount
    def test_successful_feel_envy_positive_amount(self):
        # Input values
        ...
        result = feel_envy(emotional_entity, sadness_amount, anger_amount)
    ...
    def test_successful_feel_envy_negative_amount(self):
    ...
    def test_successful_feel_envy_positive_amount_PAD(self):
    ...
    def test_successful_feel_envy_negative_amount_PAD(self):
