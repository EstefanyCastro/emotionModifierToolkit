...
def validate_amounts(pleasure_amount, activation_amount, dominance_amount, fear_amount):
...
def lambda_handler(event, context):
    ...
    validation_error = validate_amounts(
        pleasure_amount, activation_amount, dominance_amount, fear_amount
    )
    if validation_error:
        return {"statusCode": 400, "body": validation_error}

    # Upgrades fear
    updated_emotional_entity = update_fear(emotional_entity, fear_amount)
